...
import { Search, Plus, Minus, Trash2, ShoppingCart, X, ChevronLeft, ChevronRight, Tag } from 'lucide-react';
...
export default function PosIndex({ auth, products, categories, settings, filters }: PosPageProps) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800">Point of Sale</h2>}
        >
                            ...
                            <div className="px-6 py-4 border-t border-gray-200 space-y-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {settings?.tax_enabled && (
                                        <div className="flex justify-between text-sm">
                                            <span className="text-gray-600">Tax ({settings.tax_percentage}%)</span>
                                            <span className="text-gray-900 font-medium">
