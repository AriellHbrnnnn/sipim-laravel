...
import { TrendingUp, Package, ShoppingCart, DollarSign, ArrowUpRight, ArrowDownRight, Receipt, Calendar, Filter, X, Download } from 'lucide-react';
...
export default function Dashboard({ 
    ...
    const [filterType, setFilterType] = useState(filters.filter_type || 'last_7_days');
    ...
    const [showCustomDate, setShowCustomDate] = useState(filters.filter_type === 'custom');
    ...
    const applyFilter = (type: string = filterType, customStart: Date | null = null, customEnd: Date | null = null) => {
    ...
    const clearFilter = () => {
        ...
        setStartDate(null);
        setEndDate(null);
        router.get('/dashboard', { filter: 'last_7_days' }, { preserveState: true });
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800">Dashboard</h2>}
        >
            ...
            <div className="space-y-6">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500">
                                                    {transaction.cashier_name} • {transaction.date} {transaction.time}
                                                </p>
                                            </div>
                                        </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="/pos" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all">
                            <div className="p-2 bg-blue-100 rounded-lg">
                        ...
                        <a href="/products" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all">
                            <div className="p-2 bg-green-100 rounded-lg">
                        ...
                        <a href="/transactions" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all">
                            <div className="p-2 bg-purple-100 rounded-lg">
