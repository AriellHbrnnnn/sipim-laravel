              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Basic information about your store that will appear on
                    receipts
                  </p>
                </div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-2 rounded-lg ${
                            data.tax_enabled ? "bg-green-100" : "bg-gray-200"
                          }`}
                        >
                          <Percent
                            className={`w-5 h-5 ${
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setData("tax_enabled", e.target.checked)
                          }
              ...
              <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="bg-white rounded-lg p-3 border border-blue-100">
                        ...
                        <div className="text-lg font-bold text-gray-900">
                          Rp{" "}
                          {(importStats.total_revenue || 0).toLocaleString(
                            "id-ID"
                          )}
                        </div>
                      </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-5">
                  ...
                  <p className="text-sm text-green-700 mb-4">
                    Download the Excel template with sample data and proper
                    formatting
                  </p>
                      ...
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-yellow-700 mt-1">
                            Warning: This will permanently delete ALL current
                            products and transactions before importing new data.{" "}
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="bg-white border border-gray-300 rounded p-2 font-mono text-[10px]">
                        transaction_id | date | time | cashier_email |
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-300">
                    ...
                    <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
                      <li>
                        File must have exactly 2 sheets named "Products" and
                        "Transactions"
                      </li>
                      <li>
                        Product names in Transactions must match Products sheet
